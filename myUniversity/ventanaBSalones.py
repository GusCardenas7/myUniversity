...
class Ui_FormBSalones(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Buscar Salon") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """SELECT * FROM "Salon" WHERE id_salon = %s"""
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca el ID del salon a buscar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Buscar Salon"))