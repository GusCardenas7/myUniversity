...
class Ui_FormEProfesores(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Eliminar Profesor") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """DELETE FROM "Profesor" WHERE codigo_profesor = %s"""
 
            cursor.execute(consulta, ("{0}".format(self.nameLineEdit.text()),))

            connection.commit()
            count = cursor.rowcount
            print(count, "Record deleted successfully from Profesor table")
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca el codigo del profesor a eliminar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Eliminar Profesor"))