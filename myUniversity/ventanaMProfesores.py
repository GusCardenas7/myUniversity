...
class Ui_FormMProfesores(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Mostrar Profesores") 
        self.formGroupBox.setFont(QFont('Arial', 20))
        self.formGroupBox.setAlignment(Qt.AlignCenter | Qt.AlignTop)

        self.botonMostrar = QPushButton("Mostrar Profesores")
        self.botonMostrar.setFixedSize(150, 50)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Mostrar Profesores"))