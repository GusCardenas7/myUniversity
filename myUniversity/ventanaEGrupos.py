...
class Ui_FormEGrupos(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Eliminar Grupo") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """DELETE FROM "Grupo" WHERE seccion = %s"""
 
            cursor.execute(consulta, ("{0}".format(self.nameLineEdit.text()),))

            connection.commit()
            count = cursor.rowcount
            print(count, "Record deleted successfully from Grupo table")
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca la seccion del grupo a eliminar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Eliminar Grupo"))