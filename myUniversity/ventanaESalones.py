...
class Ui_FormESalones(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Eliminar Salon") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """DELETE FROM "Salon" WHERE id_salon = %s"""
 
            cursor.execute(consulta, ("{0}".format(self.nameLineEdit.text()),))

            connection.commit()
            count = cursor.rowcount
            print(count, "Record deleted successfully from Salon table")
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca el ID del salon a eliminar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Eliminar Salon"))