...
class Ui_FormECoordinadores(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Eliminar Coordinador") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """DELETE FROM "Coordinador" WHERE id_coordinador = %s"""
 
            cursor.execute(consulta, ("{0}".format(self.nameLineEdit.text()),))

            connection.commit()
            count = cursor.rowcount
            print(count, "Record deleted successfully from Coordinador table")
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca el ID del coordinador a eliminar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Eliminar Coordinador"))