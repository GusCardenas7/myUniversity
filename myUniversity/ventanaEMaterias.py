...
class Ui_FormEMaterias(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Eliminar Materia") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """DELETE FROM "Materia" WHERE clave_materia = %s"""
 
            cursor.execute(consulta, ("{0}".format(self.nameLineEdit.text()),))

            connection.commit()
            count = cursor.rowcount
            print(count, "Record deleted successfully from Materia table")
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca la clave de la materia a eliminar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Eliminar Materia"))