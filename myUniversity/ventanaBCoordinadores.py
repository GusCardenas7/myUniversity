...
class Ui_FormBCoordinadores(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Buscar Coordinador") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """SELECT * FROM "Coordinador" WHERE id_coordinador = %s"""
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca el ID del coordinador a buscar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Buscar Coordinador"))