...
class Ui_FormBMaterias(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Buscar Materia") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """SELECT * FROM "Materia" WHERE clave_materia = %s"""
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca la clave de la materia a buscar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Buscar Materia"))