...
class Ui_FormBProfesores(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Buscar Profesor") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """SELECT * FROM "Profesor" WHERE codigo_profesor = %s"""
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca el codigo del profesor a buscar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Buscar Profesor"))