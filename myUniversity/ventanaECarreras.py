...
class Ui_FormECarreras(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Eliminar Carrera") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """DELETE FROM "Carrera" WHERE clave_carrera = %s"""
 
            cursor.execute(consulta, ("{0}".format(self.nameLineEdit.text()),))

            connection.commit()
            count = cursor.rowcount
            print(count, "Record deleted successfully from Carrera table")
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca la clave de la carrera a eliminar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Eliminar Carrera"))