...
class Ui_FormBCarreras(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Buscar Carrera") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """SELECT * FROM "Carrera" WHERE clave_carrera = %s"""
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca la clave de la carrera a buscar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Buscar Carrera"))