...
class Ui_FormBAlumnos(object):
    def setupUi(self, Form):
        ...
        self.formGroupBox = QGroupBox("Buscar Alumno") 
    ...
    def getInfo(self, Form): 
        ...
        try:
            ...
            consulta = """SELECT * FROM "Alumno" WHERE codigo_alumno = %s"""
    ...
    def createForm(self): 
        ...
        self.label = QLabel("Introduzca el codigo del alumno a buscar") 
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Buscar Alumno"))